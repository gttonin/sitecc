...
<table>
	<tbody>
		<tr>
			<td>Cargo:</td>
			<td>
				<input type="text" class="text" name="docentes_cargo" placeholder="Digite o cargo do docente" value="{$cargo}" />
			</td>
		</tr>
		<tr>
			<td>Email:</td>
			<td>
				<input type="email" class="text" name="docentes_email" placeholder="Digite o email do docente" value="{$email}" />
			</td>
		</tr>
		<tr>
			<td>Lattes:</td>
			<td>
				<input type="text" class="text" name="docentes_lattes" placeholder="Digite o lattes do docente" value="{$lattes}" />
			</td>
		</tr>
		<tr>
			<td>Especialidade:</td>
			<td>
				<input type="text" class="text" name="docentes_especialidade" placeholder="Digite a especialidade do docente" value="{$especialidade}" />
			</td>
		</tr>
	</tbody>
</table>
